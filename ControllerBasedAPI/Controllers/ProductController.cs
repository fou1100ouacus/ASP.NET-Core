...
using ControllerBasedAPI.Requests;
using ControllerBasedAPI.Responses;
...
namespace ControllerBasedAPI.Controllers
{
 ...
 [HttpGet("status/{jobId}")]
  ...
  [HttpGet("products-legacy")]
    ...
    {
            //Creates a RedirectResult object 
            // that redirects (StatusCodes.Status302Found) to the specified url.
